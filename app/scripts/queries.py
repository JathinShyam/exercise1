...
def run():
    ...
    def insert_data():
        ...
        country, created = Country.objects.get_or_create(
            name="India",
            defaults={"country_code": "IN", "curr_symbol": "₹", "phone_code": "+91"},
            my_user=user,
        )
        ...
        state, created = State.objects.get_or_create(
            name="Gujarat",
            defaults={"state_code": "GJ", "gst_code": "24GUJGST", "country": country},
        )
        ...
        state, created = State.objects.get_or_create(
            name="Telangana",
            defaults={"state_code": "TS", "gst_code": "24GUFJGST", "country": country},
        )
        ...
        state, created = State.objects.get_or_create(
            name="Tamil Nadu",
            defaults={"state_code": "TN", "gst_code": "24GAUJGST", "country": country},
        )
        ...
        state, created = State.objects.get_or_create(
            name="Maharashtra",
            defaults={"state_code": "MH", "gst_code": "24GUJTGST", "country": country},
        )
    ...
    def bulk_insert_data():
        ...
        states = [
            State(name="Gujarat", state_code="GJ", gst_code="24GUJGST", country=india),
            State(
                name="Maharashtra", state_code="MH", gst_code="27MAHGST", country=india
            ),
            State(
                name="Tamil Nadu", state_code="TN", gst_code="33TNGST", country=india
            ),
            State(name="Telangana", state_code="TS", gst_code="36TLGST", country=india),
            State(name="Karnataka", state_code="KA", gst_code="29KAGST", country=india),
            State(
                name="Andhra Pradesh",
                state_code="AP",
                gst_code="37APGST",
            ...
            State(name="Kerala", state_code="KL", gst_code="32KLGST", country=india),
        ]
    ...
    def fetch_all_data():
        ...
        for city in cities:
            print(
                f"- {city.name} (State: {city.state.name}, Country: {city.state.country.name})"
            )
    ...
    def fetch_population_extremes():
        india_population = City.objects.filter(state__country__name="India").aggregate(
        ...
        min_pop_city = City.objects.filter(
            state__country__name="India", population=india_population["min_population"]
        ).first()
        max_pop_city = City.objects.filter(
            state__country__name="India", population=india_population["max_population"]
        ).first()
